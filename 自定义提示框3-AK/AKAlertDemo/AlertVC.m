...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.25 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        if (row==4) {
            av= [AKAlertView alertView:nil des:@"注销证书后将永久作废，不能使用，如使用需重新购买新证书。您需联系客服进行注销证书，客服电话031185691619"  type:AKAlertInfo effect:AKAlertEffectFade sureTitle:sureTitle cancelTitle:cancelTitle];
        }
